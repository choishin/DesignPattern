package d.Waitress.addRemove;

import java.util.Iterator;

import c.Waitress.Iterator.DinnerMenuIterator;
...
public class DinnerMenu implements Menu {
	...
	private void addItem(String name, String description, boolean vegiterian, double price) {
